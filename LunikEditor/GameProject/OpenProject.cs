...
namespace LunikEditor.GameProject
{
    ...
    class OpenProject
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\LunikEditor\";
        ...
        private static void ReadProjecData()
        {
            if(File.Exists(_projectDataPath))
            {
                ...
                foreach( var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.Lunik\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Lunik\Screenshot.png");
